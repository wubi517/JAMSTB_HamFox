...
public class VideoPlayActivity extends AppCompatActivity implements  SeekBar.OnSeekBarChangeListener, IVLCVout.Callback,View.OnClickListener, IVLCVout.OnNewVideoLayoutListener{
    ...
    int current_resolution = 0,msg_time;
    boolean first = true;
...
//        path = "http://thedab.xyz:80/series/Sup879/4knIi0SVeY/130387.mkv";
            ...
            if (event.getAction() == KeyEvent.ACTION_DOWN) {
                switch (event.getKeyCode()) {
                    ...
                    case KeyEvent.KEYCODE_MENU:
                        PackageDlg packageDlg = new PackageDlg(VideoPlayActivity.this, pkg_datas, (dialog, position) -> {
                            dialog.dismiss();
                            is_long = false;
                            switch (position) {
                                case 0:
