...
import com.gold.kds517.homFox_newui.adapter.DateListAdapter;
import com.gold.kds517.homFox_newui.adapter.EpgListAdapter;
...
import static com.gold.kds517.homFox_newui.apps.Constants.catchupFormat;
...
//            }
    ...
    private String getStrFromDate(Date date){
        ...
        return Constants.year_dateFormat.format(calendar.getTime());
    }
...
//    }
    ...
    private String getFromDate(long millisecond){
        ...
        String formattedDate=Constants.year_dateFormat.format(date);
