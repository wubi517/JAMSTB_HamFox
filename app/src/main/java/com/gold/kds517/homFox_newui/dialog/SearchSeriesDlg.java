...
import com.gold.kds517.homFox_newui.adapter.SeriesListAdapter;
...
public class SearchSeriesDlg extends Dialog implements AdapterView.OnItemClickListener {
    ...
    private List<SeriesModel> EPGChannels, search_models;
    ...
    private void initChannelData() {
        EPGChannels = MyApp.seriesModels;
    ...
    private void searchChannels(String key) {
        if (key == null || key.isEmpty()) {
            ...
            for (int i = 0; i < EPGChannels.size(); i++) {
                SeriesModel chm = EPGChannels.get(i);
